...
def parse_cli_args():
    ...
    parser.add_argument("--token", help="telegram bot token", type=str, metavar="##########:XXXXXXXXXXXXXX", default=None)
    parser.add_argument("--chat_id", help="Reserve or not", type=str, metavar="#########", default=None)
